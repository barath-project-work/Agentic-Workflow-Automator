...
import { Box, Typography, Card, CardContent, Grid, Chip, Button, TextField, InputAdornment, CircularProgress, Alert } from '@mui/material';
  ...
  return (
    <Box>
      ...
      {isLoading ? (
        ...
        <Alert severity="error" sx={{ borderRadius: 2 }}>Failed to load templates</Alert>
      ) : filtered.length === 0 ? (
